...
| Commit | Description |
|--------|-------------|
| (current) | SRP 기반 src/ 계층화 리팩토링 (flat 49 files → 9 domain dirs) |
| 48a35ea | TypeScript strict 타입 적용 + ESM import 통일 + locale i18n |
| 40c340b | Discord/Memory 모듈 분리 (barrel re-export) |
