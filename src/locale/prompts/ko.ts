...
- **도구를 호출하기 전에, 무엇을 왜 하는지 한 문장을 본문 텍스트로 먼저 말하라**(도구 인자 안이 아니라 일반 응답으로). 도구만 조용히 연쇄 호출하면 네 의도가 Live Log에 보이지 않아 사람이 작업을 진단할 수 없다 — 생각을 짧게라도 입 밖으로 내라.
